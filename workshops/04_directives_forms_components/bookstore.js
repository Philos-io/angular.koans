...
/***/ function(module, exports, __webpack_require__) {
	...
	_lib2.default.module('bookstore', ['common', 'ngRoute', 'book']).config(_routes2.default);
	
	document.addEventListener('DOMContentLoaded', function () {
	  _lib2.default.bootstrap(document.body, ['bookstore']);
	});
...
/***/ function(module, exports) {
	...
	*/ //////////////////////////////////
	...
	/* global
	  ...
	  */register('date',dateFilter);register('filter',filterFilter);register('json',jsonFilter);register('limitTo',limitToFilter);register('lowercase',lowercaseFilter);register('number',numberFilter);register('orderBy',orderByFilter);} /**
	 * @ngdoc filter
	 * @name filter
	 * @kind function
	 *
	...
	*/var VALID_CLASS='ng-valid',INVALID_CLASS='ng-invalid',PRISTINE_CLASS='ng-pristine',DIRTY_CLASS='ng-dirty',UNTOUCHED_CLASS='ng-untouched',TOUCHED_CLASS='ng-touched',PENDING_CLASS='ng-pending';var ngModelMinErr=minErr('ngModel'); /**
	 ...
	 * </example>
	 *
	 */var selectDirective=function selectDirective(){return {restrict:'E',require:['select','?ngModel'],controller:SelectController,priority:1,link:{pre:selectPreLink}};function selectPreLink(scope,element,attr,ctrls){ // if ngModel is not defined, we don't need to do anything
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bookservice = __webpack_require__(10);
	
	var _bookservice2 = _interopRequireDefault(_bookservice);
	
	var _bookaddcontroller = __webpack_require__(11);
	
	var _bookaddcontroller2 = _interopRequireDefault(_bookaddcontroller);
	
	var _bookdetailscontroller = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./detail/bookdetailscontroller\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _bookdetailscontroller2 = _interopRequireDefault(_bookdetailscontroller);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_lib2.default.module('book').controller('BookAddController', _bookaddcontroller2.default).controller('BookDetailsController', _bookdetailscontroller2.default).factory('BookFactory', _bookservice2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _navcontroller = __webpack_require__(9);
	
	var _navcontroller2 = _interopRequireDefault(_navcontroller);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_lib2.default.module('common').controller('NavController', _navcontroller2.default);
...
/***/ function(module, exports) {
	...
	exports.default = BookAddController;
